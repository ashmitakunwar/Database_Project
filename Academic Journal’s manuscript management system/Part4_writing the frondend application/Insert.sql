...
-- once data in Person table is inserted.
...
-- We created a CSV file named 'Manuscript_data.csv', which is provided in the zip file. We uploaded that file 
...
-- Following insert command will not work untill Manuscript_data.csv file is uploaded in Manuscript table. 
-- Please follow the instructions mentioned in the comment above in Manuscript section to upload CSV file. 
-- Once the table is uploaded, we can run this insert command for Author_order.
...
-- Import the CSV file 'Manuscript_Feedback_data.csv' using Table data Import Wizard, like that of Manuscript. 
-- Use existing table 'Manuscript_Feedback' while uploading. 
...
--       select * from Manuscript_Feedback; 
 
      

-- Negative scenario to test CHECK constarint

-- -----------------------------------INSERTING VALUES IN JOURNAL TABLE FOR CHECK Constraint--------------------------------------------------------------------
...
-- COMMENTING THE BELOW CODE SO THAT EXECUTION IS NOT INTERRUPTED
